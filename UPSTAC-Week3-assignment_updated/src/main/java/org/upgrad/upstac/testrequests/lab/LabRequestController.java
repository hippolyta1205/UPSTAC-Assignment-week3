...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User tester= userLoggedInService.getLoggedInUser();// creating new User object called tester

        return testRequestQueryService.findByTester(tester);// method to return test request history assigned to above tester
